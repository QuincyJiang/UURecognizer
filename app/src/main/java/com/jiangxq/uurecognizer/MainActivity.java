...
package com.jiangxq.uurecognizer;
...
import com.jiangxq.uurecognizer.env.BorderedText;
import com.jiangxq.uurecognizer.env.FileUtils;
import com.jiangxq.uurecognizer.env.ImageUtils;
import com.jiangxq.uurecognizer.env.Logger;
import com.jiangxq.uurecognizer.tracking.MultiBoxTracker;
...
public class MainActivity extends CameraActivity implements OnImageAvailableListener {
    ...
    private static int CLOSE_INIT_BAR = 0;
    private static int CLOSE_TRAINING_BAR = 1;
    private static int OPEN_INIT_BAR = 2;
    ...
    void init() {
        myHandler.sendEmptyMessage(OPEN_INIT_BAR);
        ...
        myHandler.sendEmptyMessage(CLOSE_INIT_BAR);
        initialized = true;
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            new Thread(() -> {
                ...
                myHandler.sendEmptyMessage(CLOSE_TRAINING_BAR);
            }).start();

        }
    }

    public void dismissTrainingBar(){
        trainSnackbar.dismiss();
        button.setEnabled(true);
    }
    public void showInitBar(){
      //  initSnackbar.show();
    }
    public void dismissInitBar(){
    ...
    static class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if(msg.what == CLOSE_INIT_BAR){
                activity.get().dismissInitBar();
            }
            else if(msg.what == OPEN_INIT_BAR){
                activity.get().showInitBar();
            }
            else if(msg.what == CLOSE_TRAINING_BAR){
                activity.get().dismissTrainingBar();
            }
